...
class PGD():
    ...
    def restore(self, emb_name='embeddings.'):
        ...
        for name, param in self.model.named_parameters():
            if param.requires_grad and emb_name in name and 'LayerNorm' not in name:
                assert name in self.emb_backup, '%s is not in backup'.format(name)
...
def main():
    ...
    parser.add_argument("--out_dir", type=str, default="./Limodel_bert_adv2", required=False)
    ...
    parser.add_argument("--resume_model_path", type=str, default="./Limodel_bert_adv2/pytorch_model.bin", required=False)
